...
#ifndef SMART_SZX_TRAVELING_PURCHASER_UTILITY_H
#define SMART_SZX_TRAVELING_PURCHASER_UTILITY_H
...
public:
    ...
    enum ResetOption { AllBits0 = 0, AllBits1 = -1, SafeMaxInt = 0x3F };
...
#endif // SMART_SZX_TRAVELING_PURCHASER_UTILITY_H
