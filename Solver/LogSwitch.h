...
#ifndef SMART_SZX_TRAVELING_PURCHASER_LOG_SWITCH_H
#define SMART_SZX_TRAVELING_PURCHASER_LOG_SWITCH_H
...
#endif // SMART_SZX_TRAVELING_PURCHASER_LOG_SWITCH_H
